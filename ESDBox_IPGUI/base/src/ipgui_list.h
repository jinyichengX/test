...
#ifndef __IPGUI_LIST_H
#define __IPGUI_LIST_H
...
#define IPGUI_LIST_SIZE sizeof(ipgui_list_t)
#define IPGUI_NODE_SIZE sizeof(ipgui_node_t)
...
/**
* list_head_init is a fun for init list
