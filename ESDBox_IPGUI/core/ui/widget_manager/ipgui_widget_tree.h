...
extern __IPGUI_API__ int  ipgui_widget_link_is_root(struct widget_link_t * link);
...
extern __IPGUI_API__ int  ipgui_widget_link_is_parent_of(struct widget_link_t * parent, struct widget_link_t * child);
extern __IPGUI_API__ int  ipgui_widget_link_is_child_of(struct widget_link_t * child, struct widget_link_t * parent);
