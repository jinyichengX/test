...
//     stop1.pos = 0;
//     IPGUI_COLOR_SET(stop1.color, 255, IPGUI_COLOR_214);
//     ipgui_gradient_color_stop_t stop2;
//     stop2.pos = 255;
//     IPGUI_COLOR_SET(stop2.color, 255, IPGUI_COLOR_WHITE);
...
//     wave_img.fmt = IPGUI_IMG_FMT_RGBA8888;//鍙互鏀规垚L8鎴栬€匧A88鎴栬€匯GB565璇曡瘯锛岃櫧鐒惰繖涔堟敼閫昏緫涓婁笉瀵癸紝浣嗘槸鏈夋晥鏋?
