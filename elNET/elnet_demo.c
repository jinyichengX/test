...
//     // sys_thread_t handle1;

//     // sys_thread_t handle2;
//     // handle1 = sys_thread_create(thread1, NULL);
//     // handle2 = sys_thread_create(thread2, NULL);
...
//         sys_thread_t handle[4] = { handle3, handle4, handle5, handle6 };
